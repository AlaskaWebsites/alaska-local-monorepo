...
| [ADR 002](./adrs/002-arquitetura-nestjs-validacao-zod.md) | Arquitetura NestJS e Validação Zod | Validação universal com Zod e contratos |
...
| [ADR 006](./adrs/006-modulo-agendamento-servicos-e-venda-hibrida.md) | Módulo de Agendamento e Venda Híbrida | Slots dinâmicos, extração de categorias e carrinho unificado |
...
| [ADR 013](./adrs/013-painel-do-lojista-e-gestao-operacional-em-tempo-real.md) | Painel do Lojista (Merchant Admin) | Gestão mobile, 7 abas, 4 modais e mutações otimistas |
...
| [ADR 017](./adrs/017-padronizacao-design-system-claro-suave-e-temas-dinamicos-admin.md) | Design System Claro Suave e Temas Dinâmicos no Admin | Unificação visual no padrão Claro Suave (`bg-slate-50`) e validação |
...
- [Guia de Provisionamento de Novas Demos CLI (new-demo.js)](../operations/new-demo-guide.md)
